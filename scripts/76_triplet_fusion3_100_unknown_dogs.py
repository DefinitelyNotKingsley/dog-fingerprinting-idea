...
OUT_ALL = RESULTS_DIR / "triplet_fusion3_100unknown_all.csv"
OUT_SUMMARY = RESULTS_DIR / "triplet_fusion3_100unknown_summary.csv"

N_RUNS = 100
UNKNOWN_DOGS_PER_RUN = 100
ENROLL_KS = [1, 3, 5]
...
def main():
    ...
    print("\n100-unknown-dog stress test summary:")
    print(final)
    print("\nSaved:", OUT_ALL)
