...
OUT_ALL = RESULTS_DIR / "final_100run_fusion3_best_losses_all.csv"
OUT_SUMMARY = RESULTS_DIR / "final_100run_fusion3_best_losses_summary.csv"
...
def evaluate(model, X_train_full, X_test_full, y_train, y_test, unseen_dogs, k, seed):
    ...
    profile_labels, profile_mat = make_profiles(X_enroll, y_enroll, unseen_dogs, k, seed)
    ...
    return {
        "accuracy": accuracy_score(y_probe, pred),
...
def main():
    ...
    print("Fusion3 train:", X_train_raw.shape)
    print("Fusion3 test:", X_test_raw.shape)

    assert X_train_raw.shape[1] == 1040, "Expected fusion3 to be 1040-D"
    ...
    print("\nFinal 100-run clean benchmark summary:")
