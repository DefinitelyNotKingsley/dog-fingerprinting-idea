...
OUT_PATH = RESULTS_DIR / "fingerprint_eval_results.csv"
SEED = 42
...
def main():
    X_train = np.load(RESULTS_DIR / "arcface_fusion_train_embeddings.npy")
    X_test = np.load(RESULTS_DIR / "arcface_fusion_test_embeddings.npy")
