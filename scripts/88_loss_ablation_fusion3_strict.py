...
OUT_ALL = RESULTS_DIR / "loss_ablation_fusion3_strict_all.csv"
OUT_SUMMARY = RESULTS_DIR / "loss_ablation_fusion3_strict_summary.csv"
...
def main():
    ...
    print("\nLoss ablation on fusion3 summary:")
    print(summary)
