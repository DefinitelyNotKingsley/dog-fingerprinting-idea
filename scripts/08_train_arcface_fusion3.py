...
def main():
    ...
    torch.save(model.state_dict(), MODEL_DIR / "fusion3_mlp_arcface.pt")
    torch.save(head.state_dict(), MODEL_DIR / "arcface_head.pt")

    np.save(RESULTS_DIR / "arcface_fusion3_train_embeddings.npy", train_emb)
    np.save(RESULTS_DIR / "arcface_fusion3_test_embeddings.npy", test_emb)
